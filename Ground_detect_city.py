...
#tool.0.0.1　ある近傍点の反対側の近傍点のidx確定 ver.2
def c4a(i, s):
    try:k=s.index(i)
...
#tool.0.2 符号付相対高度 ver.1
def dis(i1,i2):
    return data[i1][2]-data[i2][2]

#step.2 基準値に最も近い未判定点idx確定 ver.3
def find_std(data):
    mindis=10000
    minidx = None
